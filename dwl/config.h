...
static const char *menucmd[] = { "wmenu-run", "-f", "Mono 13", NULL };
static const char *lockcmd[] = { "waylock", NULL };

/* media keys */
static const char *vold[] = { 
	"/bin/sh", "-c",
	"pactl set-sink-volume @DEFAULT_SINK@ -5% && pactl set-sink-mute @DEFAULT_SINK@ 0", NULL };
static const char *volu[] = { 
	"/bin/sh", "-c",
	"pactl set-sink-volume @DEFAULT_SINK@ +5% && pactl set-sink-mute @DEFAULT_SINK@ 0", NULL };
static const char *togglemute[] = { "pactl", "set-sink-mute", "@DEFAULT_SINK@", "toggle", NULL };
static const char *play[] = { NULL };
static const char *next[] = { NULL };
static const char *prev[] = { NULL };
static const char *stop[] = { NULL };
static const char *backlu[] = { "brightnessctl", "--exponent=8", "s", "+5%", NULL };
static const char *backld[] = { "brightnessctl", "--exponent=8", "s", "5%-", NULL };
static const char *prtscr[] = { "grim", "~/screenshot.png", NULL};
...
static const Key keys[] = {
	...
	{ 0,                      XKB_KEY_XF86AudioStop,               spawn,          {.v = stop } },
	{ 0,                      XKB_KEY_XF86MonBrightnessUp,         spawn,          {.v = backlu } },
	{ 0,                      XKB_KEY_XF86MonBrightnessDown,       spawn,          {.v = backld } },
	{ 0,                      XKB_KEY_Print,                       spawn,          {.v = prtscr } },
