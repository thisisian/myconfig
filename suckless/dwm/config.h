...
static const char *fonts[]          = { "terminus:pixelsize=16:antialias=false:autohint:false" };
...
static const char col_darkblue[]    = "#000044";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray4, col_darkblue, col_black },
	[SchemeSel]  = { col_darkblue, col_gray4,  col_gray4 },
};
